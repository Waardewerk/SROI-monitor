...
export const seededGemeenten: GemeenteInfo[] = [
  ...
  // ── Utrecht ──
  {
    ...
    bouwblokwaarden: [
      ...
      { sectie: 'Banen & leerwerkplekken', label: 'Ingeschreven in doelgroepregister UWV (met arbeidsbeperking)', waarde: '€ 50.000 (jaarcontract 36 uur/week)' },
      { sectie: 'Banen & leerwerkplekken', label: 'Leerwerkplek praktijk- en voortgezet speciaal onderwijs / mbo niveau 1', waarde: '€ 35.000 (jaarcontract 36 uur/week)' },
      { sectie: 'Banen & leerwerkplekken', label: 'WIA- of WAO-uitkering van UWV', waarde: '€ 40.000 (jaarcontract 36 uur/week)' },
      { sectie: 'Banen & leerwerkplekken', label: 'WW-uitkering van UWV', waarde: '€ 20.000 (jaarcontract 36 uur/week)' },
      { sectie: 'Banen & leerwerkplekken', label: 'Mbo bbl (beroepsbegeleidende leerweg) niveau 2, 3 en 4', waarde: '€ 35.000 (jaarcontract 36 uur/week)' },
      { sectie: 'Banen & leerwerkplekken', label: 'Mbo bol (beroepsopleidende leerweg) niveau 2, 3 en 4', waarde: '€ 20.000 (jaarcontract 36 uur/week)' },
      { sectie: 'Banen & leerwerkplekken', label: 'Geen recht op uitkering', waarde: '€ 10.000 (jaarcontract 36 uur/week)' },
      // Bonussen
      { sectie: 'Bonussen', label: 'Ouder dan 50 jaar', waarde: '+ € 10.000' },
      { sectie: 'Bonussen', label: 'Statushouders en werkzoekenden met een taalachterstand', waarde: '+ € 10.000' },
      { sectie: 'Bonussen', label: 'Vast contract', waarde: '+ € 10.000' },
      // Andere invulling
      { sectie: 'Andere invulling', label: 'Inkopen bij sociale bedrijven', waarde: '(Loon)kosten excl. btw' },
      ...
      { sectie: 'Andere invulling', label: 'Scholing en ontwikkeling social return-medewerkers', waarde: 'In overleg met adviseur' },
      { sectie: 'Andere invulling', label: 'Werkzoekenden met een uitkering ondersteunen richting werk', waarde: 'In overleg met adviseur' },
    ],
    isSeeded: true,
  },
...
,
  {
    naam: 'Arnhem', gmCode: 'GM0202', provincie: 'Gelderland',
    werkloosheid: 8.2, bijstand: 6500, buigBudget: 117000000, reintegratiebudget: 10530000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
    doelgroepen: { bijstand: { n: 6500, bereikbaarheid: 55 }, nuggers: { n: 2275, bereikbaarheid: 40 }, statushouders: { n: 780, bereikbaarheid: 35 }, vsv: { n: 520, bereikbaarheid: 25 }, arbeidsbeperkt: { n: 1300, bereikbaarheid: 45 }, ouderen55plus: { n: 975, bereikbaarheid: 30 } },
    instellingen: [],
    contactpersonen: [{ naam: 'Steunpunt SROI Arnhem', telefoon: '06-46737396', email: 'socialreturn@arnhem.nl', regio: 'Arnhem (Midden-Gelderland)' }],
    isSeeded: true,
  },
  {
    naam: 'Nijmegen', gmCode: 'GM0268', provincie: 'Gelderland',
    werkloosheid: 7.4, bijstand: 6000, buigBudget: 108000000, reintegratiebudget: 9720000,
    sroi: { pct: 5, status: 'Verplicht', drempel: 250000, monitoring: 'Kwartaal', methode: 'Bouwblokken (Oost NL 2026)', uitvoerder: 'Expertisecentrum Social Return (ESR)', registratiesysteem: 'WIZZR' },
    doelgroepen: { bijstand: { n: 6000, bereikbaarheid: 55 }, nuggers: { n: 2100, bereikbaarheid: 40 }, statushouders: { n: 720, bereikbaarheid: 35 }, vsv: { n: 480, bereikbaarheid: 25 }, arbeidsbeperkt: { n: 1200, bereikbaarheid: 45 }, ouderen55plus: { n: 900, bereikbaarheid: 30 } },
    instellingen: ['Expertisecentrum Social Return (ESR)'],
    contactpersonen: [{ naam: 'Niels Veen', telefoon: '06-29652260', email: 'sroiloketrvn@wbrn.nl', regio: 'SROI Loket Rijk van Nijmegen (WerkBedrijf RvN)' }],
    bouwblokwaarden: [
      { sectie: 'Werken', label: 'Participatiewet', waarde: '€ 45.000/jaar (max 2 jr)' },
      { sectie: 'Werken', label: 'Participatiewet en Wajong (doelgroepregister) / WIA/WAO / WSW / Beschut Werk', waarde: '€ 50.000/jaar (altijd)' },
      { sectie: 'Werken', label: 'WW', waarde: '€ 20.000/jaar (max 1 jr)' },
  ...
  {
    naam: 'Amersfoort', gmCode: 'GM0307', provincie: 'Utrecht',
    werkloosheid: 5.2, bijstand: 4500, buigBudget: 81000000, reintegratiebudget: 7290000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
    doelgroepen: { bijstand: { n: 4500, bereikbaarheid: 55 }, nuggers: { n: 1575, bereikbaarheid: 40 }, statushouders: { n: 540, bereikbaarheid: 35 }, vsv: { n: 360, bereikbaarheid: 25 }, arbeidsbeperkt: { n: 900, bereikbaarheid: 45 }, ouderen55plus: { n: 675, bereikbaarheid: 30 } },
    instellingen: [],
    contactpersonen: [{ naam: 'WSP regio Amersfoort — Roy Koppenol', telefoon: '06-34341249', email: 'socialreturn@amersfoort.nl', regio: 'Amersfoort' }],
    isSeeded: true,
  },
  {
    naam: 'Leiden', gmCode: 'GM0546', provincie: 'Zuid-Holland',
    werkloosheid: 6.9, bijstand: 5000, buigBudget: 90000000, reintegratiebudget: 8100000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
    doelgroepen: { bijstand: { n: 5000, bereikbaarheid: 55 }, nuggers: { n: 1750, bereikbaarheid: 40 }, statushouders: { n: 600, bereikbaarheid: 35 }, vsv: { n: 400, bereikbaarheid: 25 }, arbeidsbeperkt: { n: 1000, bereikbaarheid: 45 }, ouderen55plus: { n: 750, bereikbaarheid: 30 } },
    instellingen: [],
    contactpersonen: [{ naam: 'Social Return Leiden (DZB)', email: 'info@socialreturn.nu', regio: 'Leiden' }],
    isSeeded: true,
  },
  {
    naam: 'Dordrecht', gmCode: 'GM0505', provincie: 'Zuid-Holland',
    werkloosheid: 8.1, bijstand: 5500, buigBudget: 99000000, reintegratiebudget: 8910000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
  ...
  {
    naam: 'Maastricht', gmCode: 'GM0935', provincie: 'Limburg',
    werkloosheid: 7.8, bijstand: 5200, buigBudget: 93600000, reintegratiebudget: 8424000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
    doelgroepen: { bijstand: { n: 5200, bereikbaarheid: 55 }, nuggers: { n: 1820, bereikbaarheid: 40 }, statushouders: { n: 624, bereikbaarheid: 35 }, vsv: { n: 416, bereikbaarheid: 25 }, arbeidsbeperkt: { n: 1040, bereikbaarheid: 45 }, ouderen55plus: { n: 780, bereikbaarheid: 30 } },
    instellingen: [],
    contactpersonen: [{ naam: 'Rimone Dielesen', telefoon: '06-27850842', email: 'rimone.dielesen@maastricht.nl', regio: 'Maastricht (Zuid-Limburg)' }],
    isSeeded: true,
  },
  {
    naam: 'Goes', gmCode: 'GM0664', provincie: 'Zeeland',
    werkloosheid: 5.5, bijstand: 1200, buigBudget: 21600000, reintegratiebudget: 1944000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
    ...
    instellingen: [],
    contactpersonen: [{ naam: 'Centrumgemeente Zeeland — Social Return', telefoon: '140113', email: 'socialreturn@goes.nl', regio: 'Goes (arbeidsmarktregio Zeeland)' }],
    isSeeded: true,
  },
  {
    naam: 'Den Helder', gmCode: 'GM0400', provincie: 'Noord-Holland',
    werkloosheid: 7.0, bijstand: 2800, buigBudget: 50400000, reintegratiebudget: 4536000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
    doelgroepen: { bijstand: { n: 2800, bereikbaarheid: 55 }, nuggers: { n: 980, bereikbaarheid: 40 }, statushouders: { n: 336, bereikbaarheid: 35 }, vsv: { n: 224, bereikbaarheid: 25 }, arbeidsbeperkt: { n: 560, bereikbaarheid: 45 }, ouderen55plus: { n: 420, bereikbaarheid: 30 } },
    instellingen: [],
    contactpersonen: [{ naam: 'Social Return coördinator Den Helder', telefoon: '140223', email: 'socialreturn@denhelder.nl', regio: 'Den Helder (Noord-Holland Noord)' }],
    isSeeded: true,
  },
  {
    naam: 'Haarlemmermeer', gmCode: 'GM0394', provincie: 'Noord-Holland',
    werkloosheid: 3.8, bijstand: 3500, buigBudget: 63000000, reintegratiebudget: 5670000,
    sroi: { pct: 5, status: 'In ontwikkeling', drempel: 250000 },
    doelgroepen: { bijstand: { n: 3500, bereikbaarheid: 55 }, nuggers: { n: 1225, bereikbaarheid: 40 }, statushouders: { n: 420, bereikbaarheid: 35 }, vsv: { n: 280, bereikbaarheid: 25 }, arbeidsbeperkt: { n: 700, bereikbaarheid: 45 }, ouderen55plus: { n: 525, bereikbaarheid: 30 } },
    instellingen: [],
  ...
  {
    naam: 'Bernheze', gmCode: 'GM0755', provincie: 'Noord-Brabant',
    werkloosheid: 3.8, bijstand: 430, buigBudget: 7700000, reintegratiebudget: 700000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
      registratiesysteem: 'WIZZR',
    },
    doelgroepen: { bijstand: { n: 430, bereikbaarheid: 50 }, nuggers: { n: 150, bereikbaarheid: 35 }, statushouders: { n: 43, bereikbaarheid: 28 }, vsv: { n: 30, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 77, bereikbaarheid: 40 }, ouderen55plus: { n: 64, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
      { sectie: 'Doelgroepen', label: 'Niet-uitkeringsgerechtigde (NUG)', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
      { sectie: 'Doelgroepen', label: 'WIA / WAO / WAZ / Wajong', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
      ...
      { sectie: 'Bonussen', label: 'Bonus leeftijd 50–54 jaar', waarde: '€ 5.000 eenmalig' },
      { sectie: 'Bonussen', label: 'Bonus leeftijd 55 jaar of ouder', waarde: '€ 10.000 eenmalig' },
      { sectie: 'Maatschappelijke meerwaarde', label: 'Gastles over bedrijf / branche / sector', waarde: '€ 100/uur (max 2 uur per les)' },
      { sectie: 'Maatschappelijke meerwaarde', label: 'Bedrijfsbezoek', waarde: '€ 100/uur (max 4 uur per bezoek)' },
      { sectie: 'Maatschappelijke meerwaarde', label: 'Activiteiten onderliggende problematiek doelgroep', waarde: '€ 100/uur of factuur (max 4 uur; vooraf akkoord coördinator)' },
      { sectie: 'Maatschappelijke meerwaarde', label: 'Begeleiding re-integratie- of werkervaringstraject', waarde: 'Max 2 uur/week × € 100/uur' },
      { sectie: 'Arbeidsontwikkeling', label: 'Scholing / om-, her- en bijscholing van doelgroepkandidaten', waarde: 'Factuurkosten excl. BTW (vooraf akkoord coördinator)' },
      { sectie: 'PSO-gecertificeerd inkopen', label: 'PSO trede 1', waarde: '10% van factuur excl. BTW' },
      { sectie: 'PSO-gecertificeerd inkopen', label: 'PSO trede 2', waarde: '20% van factuur excl. BTW | trede 2+ = vrijstelling SR (max 5%)' },
      { sectie: 'PSO-gecertificeerd inkopen', label: 'PSO trede 3', waarde: '30% van factuur excl. BTW | trede 2+ = vrijstelling SR (max 5%)' },
      { sectie: 'PSO-gecertificeerd inkopen', label: 'PSO 30+ / sociale onderneming (Weener XL, WSD, IBN)', waarde: '100% van factuur excl. BTW' },
    ],
    isSeeded: true,
  },
  {
    naam: 'Boekel', gmCode: 'GM0756', provincie: 'Noord-Brabant',
    werkloosheid: 3.5, bijstand: 130, buigBudget: 2300000, reintegratiebudget: 210000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 130, bereikbaarheid: 50 }, nuggers: { n: 46, bereikbaarheid: 35 }, statushouders: { n: 13, bereikbaarheid: 28 }, vsv: { n: 9, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 23, bereikbaarheid: 40 }, ouderen55plus: { n: 20, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
  ...
  {
    naam: 'Boxtel', gmCode: 'GM0757', provincie: 'Noord-Brabant',
    werkloosheid: 4.2, bijstand: 560, buigBudget: 10000000, reintegratiebudget: 900000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 560, bereikbaarheid: 50 }, nuggers: { n: 196, bereikbaarheid: 35 }, statushouders: { n: 56, bereikbaarheid: 28 }, vsv: { n: 39, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 101, bereikbaarheid: 40 }, ouderen55plus: { n: 84, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
  ...
  {
    naam: 'Land van Cuijk', gmCode: 'GM1978', provincie: 'Noord-Brabant',
    werkloosheid: 5.1, bijstand: 1600, buigBudget: 28800000, reintegratiebudget: 2600000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 1600, bereikbaarheid: 50 }, nuggers: { n: 560, bereikbaarheid: 35 }, statushouders: { n: 160, bereikbaarheid: 28 }, vsv: { n: 112, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 288, bereikbaarheid: 40 }, ouderen55plus: { n: 240, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
  ...
  {
    naam: 'Maashorst', gmCode: 'GM1991', provincie: 'Noord-Brabant',
    werkloosheid: 4.6, bijstand: 850, buigBudget: 15300000, reintegratiebudget: 1400000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 850, bereikbaarheid: 50 }, nuggers: { n: 298, bereikbaarheid: 35 }, statushouders: { n: 85, bereikbaarheid: 28 }, vsv: { n: 60, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 153, bereikbaarheid: 40 }, ouderen55plus: { n: 128, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
  ...
  {
    naam: 'Meierijstad', gmCode: 'GM1948', provincie: 'Noord-Brabant',
    werkloosheid: 4.4, bijstand: 1450, buigBudget: 26100000, reintegratiebudget: 2350000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 1450, bereikbaarheid: 50 }, nuggers: { n: 507, bereikbaarheid: 35 }, statushouders: { n: 145, bereikbaarheid: 28 }, vsv: { n: 102, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 261, bereikbaarheid: 40 }, ouderen55plus: { n: 218, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
  ...
  {
    naam: 'Oss', gmCode: 'GM0828', provincie: 'Noord-Brabant',
    werkloosheid: 5.3, bijstand: 2600, buigBudget: 46800000, reintegratiebudget: 4200000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 2600, bereikbaarheid: 50 }, nuggers: { n: 910, bereikbaarheid: 35 }, statushouders: { n: 260, bereikbaarheid: 28 }, vsv: { n: 182, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 468, bereikbaarheid: 40 }, ouderen55plus: { n: 390, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
  ...
  {
    naam: 'Sint-Michielsgestel', gmCode: 'GM0845', provincie: 'Noord-Brabant',
    werkloosheid: 3.6, bijstand: 350, buigBudget: 6300000, reintegratiebudget: 570000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 350, bereikbaarheid: 50 }, nuggers: { n: 122, bereikbaarheid: 35 }, statushouders: { n: 35, bereikbaarheid: 28 }, vsv: { n: 25, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 63, bereikbaarheid: 40 }, ouderen55plus: { n: 52, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
  ...
  {
    naam: 'Vught', gmCode: 'GM0865', provincie: 'Noord-Brabant',
    werkloosheid: 3.9, bijstand: 410, buigBudget: 7400000, reintegratiebudget: 660000,
    sroi: {
      pct: 5, status: 'Verplicht', drempel: 221000,
      methode: 'Normbedragen (Arbeidsmarktregio Noordoost-Brabant 2025)',
      uitvoerder: 'Coördinator Social Return Arbeidsmarktregio Noordoost-Brabant',
    ...
    doelgroepen: { bijstand: { n: 410, bereikbaarheid: 50 }, nuggers: { n: 144, bereikbaarheid: 35 }, statushouders: { n: 41, bereikbaarheid: 28 }, vsv: { n: 29, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 74, bereikbaarheid: 40 }, ouderen55plus: { n: 62, bereikbaarheid: 30 } },
    instellingen: ['Weener XL', 'WSD', 'IBN', 'WSP Noordoost-Brabant'],
    contactpersonen: [{ naam: 'Coördinator Social Return', regio: 'Arbeidsmarktregio Noordoost-Brabant' }],
    bouwblokwaarden: [
      { sectie: 'Doelgroepen', label: 'Participatiewet / IOAW / IOAZ', waarde: '€ 45.000/jaar (fulltime) | € 24/uur (inleen)' },
