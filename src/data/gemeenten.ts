...
,
  ...
  // ── Krimpen aan den IJssel ──
  {
    ...
    sroi: {
      pct: 5, status: 'Actief beleid', drempel: 50000,
      methode: 'Regionaal beleid SUWI Rijnmond 2022-2025',
      uitvoerder: 'Gemeente Krimpen aan den IJssel (regionale spelregels)',
      monitoring: 'Per opdracht afgesproken',
    },
    doelgroepen: { bijstand: { n: 890, bereikbaarheid: 45 }, nuggers: { n: 310, bereikbaarheid: 32 }, statushouders: { n: 110, bereikbaarheid: 25 }, vsv: { n: 60, bereikbaarheid: 18 }, arbeidsbeperkt: { n: 178, bereikbaarheid: 38 }, ouderen55plus: { n: 133, bereikbaarheid: 28 } },
    instellingen: ['IJsselgemeenten', 'Promen', 'UWV Capelle aan den IJssel'],
    bouwblokwaarden: [
      { sectie: 'Beleid', label: 'Drempel toepassing Social Return', waarde: '€ 50.000 of meer (indien mogelijk)' },
      { sectie: 'Beleid', label: 'SR-percentage', waarde: '5% van opdrachtwaarde (conform regionale spelregels SUWI Rijnmond 2022-2025)' },
      { sectie: 'Beleid', label: 'Invulling', waarde: 'Vrij binnen beschreven mogelijkheden, bij voorkeur gerelateerd aan opdracht' },
    ],
    isSeeded: true,
  },
